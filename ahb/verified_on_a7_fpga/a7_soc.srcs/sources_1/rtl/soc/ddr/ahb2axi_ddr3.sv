...
(
	...
	(
		...
		.s_ahb_hsel       (hsel_i           ),        // input wire hsel_i
		.s_ahb_haddr      (haddr_i          ),        // input wire [31 : 0] haddr_i
		.s_ahb_hwdata     (hwdata_i         ),        // input wire [31 : 0] hwdata_i
		.s_ahb_hwrite     (hwrite_i         ),        // input wire hwrite_i
		.s_ahb_hsize      (hsize_i          ),        // input wire [2 : 0] hsize_i
		.s_ahb_hburst     (hburst_i         ),        // input wire [2 : 0] hburst_i
		.s_ahb_hprot      (hprot_i          ),        // input wire [3 : 0] hprot_i
		.s_ahb_htrans     (htrans_i         ),        // input wire [1 : 0] htrans_i
